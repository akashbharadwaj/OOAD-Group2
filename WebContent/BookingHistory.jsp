        ...
        <tbody>
            <c:forEach items="${bookings}" var="booking">
                <tr>
                    ...
                    <td><a class = "btn btn-danger" href="${pageContext.request.contextPath}/BookingController?Uid=<c:out value="${user}"/>&Bid=<c:out value="${booking.bookingId}"/>&show=2">Cancel</a></td>
				</tr>
            </c:forEach>
        </tbody>
    </table> 
