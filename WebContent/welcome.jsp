        ...
        <tbody>
            <c:forEach items="${arenas}" var="arenas">
                <tr>
                    ...
                    <td><a  class = "btn btn-success" id = "${arenas.arenaID}" href="${pageContext.request.contextPath}/BookingController?Uid=<c:out value="${user}"/>&Aid=<c:out value="${arenas.arenaID}"/>&show=0">Book</a></td>
                </tr>
            </c:forEach>
        </tbody>
    </table> 
